                  ...
                  <div class="col-lg-4 col-sm-6 col-md-3">
                    <form action="insert.jsp" method="post">
                        <div style="padding-top: 200px; color: #ffffff;">
                           ...
                           <input type="hidden" name="item_name" value="<%=rec.getString("name")%>"  class="form-control" style="border-radius: 25px;">
                           <br>
                           <h3 align="right">descript : <%=rec.getString("descript")%></h3>
                           <br>
                           <h3 align="right">price : <%=rec.getString("price")%> ฿</h3>
                           <input type="hidden" name="item_price" value="<%=rec.getString("price")%>"  class="form-control" style="border-radius: 25px;">
                           <br>
                           <input type="text" placeholder="Address :" name="address"  class="form-control" style="border-radius: 25px;">
                           <hr>
                           <div style="text-align: right;">
                                <input type="submit" name="submit" class="btn btn-success btn-lg" style="border-radius: 15px;" value="KUY" />
                           </div>
                        </div>
                    </form>
                  </div>
