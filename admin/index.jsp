...
%>
                    <tr>
                      <td><%=rec1.getString("id")%></td>
                      <td><%=rec1.getString("username")%></td>
                      <td><%=rec1.getString("password")%></td>
                      <td><%=rec1.getString("name")%></td>
                      <td><%=rec1.getString("email")%></td>
                      <td><%=rec1.getString("tel")%></td>
                    </tr>
<% } 
  }catch(Exception e){
...
%>
                    <tr>
                      <td><%=rec2.getString("id")%></td>
                      <td><img src="<%=rec2.getString("image")%>" width="120px"></td>
                      <td><%=rec2.getString("name")%></td>
                      <td><%=rec2.getString("price")%></td>
                      <td><%=rec2.getString("descript")%></td>
                    </tr>
<% } 
    }catch(Exception e){
        out.println(e.getMessage());
...
%>
        ...
        connect = DriverManager.getConnection("jdbc:mysql://localhost/oom_shop"+"?user=root&password=12345678");
        s = connect.createStatement();
        String sql3 = "SELECT * FROM descript";
        ResultSet rec3 = s.executeQuery(sql3);

        while((rec3 != null)&&(rec3.next())){
%>
                    <tr>
                      <td><%=rec3.getString("id")%></td>
                      <td><%=rec3.getString("item_name")%></td>
                      <td><%=rec3.getString("Item_price")%></td>
                      <td><%=rec3.getString("address")%></td>
                    </tr>
<% } 
  }catch(Exception e){
        out.println(e.getMessage());
